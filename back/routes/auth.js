...
const { registroUsuario, loginUser,
     logOut, forgotPassword,
      resetPassword, getUserProfile,
       updatePassword, updateProfile,
        getAllUsers, getUserDetails,
...
router.route('/mycount').get(isAuthenticatedUser,getUserProfile)
router.route('/mycount/updatePassword').put(isAuthenticatedUser,updatePassword)
router.route('/mycount/updateProfile').put(isAuthenticatedUser,updateProfile)
