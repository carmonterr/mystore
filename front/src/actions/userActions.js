...
export const loadUser=()=> async(dispatch) =>{
    try{
        ...
        const {data} = await axios.get("/api/mycount")
        dispatch({
...
export const updateProfile = (userData) => async (dispatch) => {
    try {
        ...
        const {data} = await axios.put('/api/mycount/updateProfile', userData, config)
...
export const updatePassword = (passwords) => async (dispatch) => {
    try {
        ...
        const {data} = await axios.put('/api/mycount/updatePassword', passwords, config)
