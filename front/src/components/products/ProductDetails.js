...
import { clearErrors, getProductDetails, newReview } from '../../actions/ProductAtions';
    ...
    :(
        ...
        <Carousel pause ='hover'>
            ...
            <div className='col-12 col-lg-5 mt-5'>
                ...
                <p id="product_id">ID el producto{product._id}</p>
                <hr />

                <div className='rating-outer'>
                  <div className='rating-inner' style={{width:`${(product.calificacion/5)*100}%`}}></div>
                  </div>
                  <span id ="No de reviews">{product.numCalificaciones}reviews</span>
                
                <hr />
                <p id='Precio_ Producto'>${product.precio}</p>
                <div className='stockCounter d-inline'>
                  <span className='bnt btn-danger minus' onClick={decreaseQty}>-</span>
                  <input type="number" className="from-control count d-line" value={quantity} readOnly></input>
              ...
              <hr />
              <p id='Vendedor'>Vedido por:<strong>{product.vendedor}</strong></p>
              { user ?
              <button id='btn-review'type='button'className='btn btn-primary mt-4'
              data-toggle='modal'data-target='#ratingModal' onClick={setUserRatings}>Deja tu opinion</button>
               :
              <div className=' alert alert-danger mt-5'type='alert'>Inicie Sesion para dejar su review</div>
              }
                {/* deja tu comentario */}
                      ...
                      <div className='modal-dialog'role='document'>
                        <div className='modal-content'>
                          < div className='modal-header'>
                              <h5 className='modal-title' id='ratingModalLabel'>Enviar reviews</h5>
